...
public class PersonActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainRecyclerView = (RecyclerView) findViewById(R.id.person_recyclerView);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        group = getIntent().getParcelableExtra(GroupActivity.class.getSimpleName());

        if(group != null){
            Toast.makeText(activity, "Group:" +group.getGroupName(), Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(activity, "New Group", Toast.LENGTH_SHORT).show();
        }
